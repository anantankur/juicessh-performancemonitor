...
import com.sonelli.juicessh.performancemonitor.monitor.ChartView;
                        ...
                        public void onOutputLine(String line) {
                            ...
                            if(cpuOldMatcher.find()){
                                ...
                                if(previousIdle.get() > -1 || previousTotal.get() > -1) {
                                    ...
                                    setText((100 - free) + "%");
                                    cpuStat = 100-free;
                                    if (new ChartView().chartActive) {
//                                        chartView.addEntry(cpuStat);
                                        new ChartView().updater(cpuStat);
                                    }
                                    Log.d("random free", String.valueOf(100-free));
                                    Log.d("cpustats", String.valueOf(cpuStat));
                                }
